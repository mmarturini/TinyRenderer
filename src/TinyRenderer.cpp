...
void triangle(Vec3f* pts, float* zbuffer, TGAImage& image, TGAColor color) {
    // Computing triangle bounding box
    ...
    // For every pixel in bounding box, compute barycentric coordinates wrt triangle
    // if any of the barycentric coordinates is negative, then pixel is outside triangle
    // zbuffer is used to keep track of the closest triangle to the camera, to avoid overdraw
    Vec3f P;
